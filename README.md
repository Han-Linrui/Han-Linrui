...
### 🔬 Research Interests
- **RL-based Alignment:** Utilizing MAB, PPO, and DPO for post-training and test-time intervention.
- **Agentic & Embodied AI:** Grounding foundation models in dynamic environments (Data Science tasks or Physical Simulators).

### 🚀 Featured Project
- [**LOLA-RL-Alignment**]((https://github.com/Han-Linrui/LOLA-Algorithm-Reproduction-Analysis))
  A mechanistic, from-scratch reproduction of the `LLM-2UCB` algorithm. This project demonstrates how Multi-Armed Bandit (MAB) online feedback can mathematically bound and dynamically correct the static hallucinations of Large Language Models. 
